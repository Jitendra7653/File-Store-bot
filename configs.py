...
class Config(object):
  ...
  DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002179247918"))
  SHORTLINK_URL = os.environ.get('SHORTLINK_URL', "link.ai1t.in")
  ...
  LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002179247918"))
...
"""
  ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿: [Chandra Prakash](https://telegram.me/Jitendra7653)
"""
  HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **FileStore Bot**.
